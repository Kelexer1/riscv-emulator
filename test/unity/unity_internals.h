...
#define UNITY_TEST_ASSERT_NOT_EQUAL_UINT(threshold, actual, line, message)                                             \
  UnityAssertUintGreaterOrLessOrEqualNumber((UNITY_UINT)(threshold), (UNITY_UINT)(actual), UNITY_NOT_EQUAL, (message), \
...
#define UNITY_TEST_ASSERT_NOT_EQUAL_UINT16(threshold, actual, line, message)                                           \
  UnityAssertUintGreaterOrLessOrEqualNumber((UNITY_UINT)(UNITY_UINT16)(threshold), (UNITY_UINT)(UNITY_UINT16)(actual), \
                                            UNITY_NOT_EQUAL, (message), (UNITY_LINE_TYPE)(line),                       \
                                            UNITY_DISPLAY_STYLE_UINT16)
#define UNITY_TEST_ASSERT_NOT_EQUAL_UINT32(threshold, actual, line, message)                                           \
  UnityAssertUintGreaterOrLessOrEqualNumber((UNITY_UINT)(UNITY_UINT32)(threshold), (UNITY_UINT)(UNITY_UINT32)(actual), \
                                            UNITY_NOT_EQUAL, (message), (UNITY_LINE_TYPE)(line),                       \
...
#define UNITY_TEST_ASSERT_GREATER_THAN_INT(threshold, actual, line, message)                                           \
  UnityAssertIntGreaterOrLessOrEqualNumber((UNITY_INT)(threshold), (UNITY_INT)(actual), UNITY_GREATER_THAN, (message), \
                                           (UNITY_LINE_TYPE)(line), UNITY_DISPLAY_STYLE_INT)
...
#define UNITY_TEST_ASSERT_SMALLER_THAN_INT(threshold, actual, line, message)                                           \
  UnityAssertIntGreaterOrLessOrEqualNumber((UNITY_INT)(threshold), (UNITY_INT)(actual), UNITY_SMALLER_THAN, (message), \
                                           (UNITY_LINE_TYPE)(line), UNITY_DISPLAY_STYLE_INT)
...
#define UNITY_TEST_ASSERT_INT_WITHIN(delta, expected, actual, line, message)                                           \
  UnityAssertIntNumbersWithin((delta), (UNITY_INT)(expected), (UNITY_INT)(actual), (message), (UNITY_LINE_TYPE)(line), \
                              UNITY_DISPLAY_STYLE_INT)
